...
import 'package:furniture_store_app/admin/admin_upload_items.dart';
...
class _AdminLoginScreenState extends State<AdminLoginScreen>
{
  ...
  loginAdminNow() async //waiting for a response
      {
    try
    {
      ...
      if(res.statusCode==200)
      {
        ...
        {
          Fluttertoast.showToast(msg: "Admin, you are logged in.");
                      ...
                      child: Column
                        ...
                        [
                          ...
                          Row
                            ...
                            children:
                            [
                              const Text("Not an admin?", style: TextStyle
                                (
                                color: Colors.black,
                                fontSize: 17,
                              ),
